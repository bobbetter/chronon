...
source = EntitySource(
    ...
    query=Query(
        selects=selects("user_id", "account_created_ds", "email_verified"),  # Select the fields we care about
    ),
)
...
v1 = GroupBy(
    ...
    aggregations=[],  # In this case, there are no aggregations or windows to define
    online=True,
    version=1,
) 