...
source = EventSource(
    ...
    topic="events.returns/fields=ts,return_id,user_id,product_id,refund_amt/host=kafka/port=9092/serde=custom/provider_class=ai.chronon.flink.deser.ReturnsSerDe",
    query=Query(
