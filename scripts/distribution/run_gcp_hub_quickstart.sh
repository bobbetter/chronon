...
zipline hub backfill compiled/staging_queries/gcp/sample_staging_query.v1_hub__0 --repo=$CHRONON_ROOT --start-ds 2023-12-01 --end-ds 2023-12-01 | tee tmp_backfill.out
